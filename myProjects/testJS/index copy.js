...
function startBigMan() {
    ...
    /* setInterval(function () {
        bigMan.speed.x = (bigMan.speed.x > 0 ? 5 : -5)
        bigMan.speed.y = 0 
        bigMan.speed.y = Math.sin(((bigMan.speed.x > 0) ? bigMan.speed.x : bigMan.speed.x * -1)) * bigMan.speed.x
    ...
    function updateHTML() {
        ...
        $("#TBhits").text(TBhits)
        $("#wallHits").text(wallHits)
        $("#cornerHits").text(cornerHits)
    }
}