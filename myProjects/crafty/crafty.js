...
(function e(t, n, r) {
        ...
        Crafty.c("Jumper", {
            ...
            jumper: function (jumpSpeed, jumpKeys) {
                ...
                if (Array.isArray(jumpKeys)) {
                    ...
                    Crafty.s("Controls")
                        .defineTriggerGroup(this._jumpTriggerName, {
                            keys: keys
                        });
                } else {
                    Crafty.s("Controls")
    ...
    20: [function (require, module, exports) {
        ...
        "./debug/logging": 23,
        "./spatial/2d": 54,
        "./spatial/collision": 55,
        "./spatial/math": 56,
        "./spatial/motion": 57,
        "./spatial/platform": 58,
        "./spatial/rect-manager": 59,
        "./spatial/spatial-grid": 60
    }],
    21: [function (require, module, exports) {
        ...
        "./core/loader": 12,
        "./crafty-common.js": 20,
        "./debug/debug-layer": 22,
        "./graphics/canvas": 25,
        "./graphics/canvas-layer": 24,
        "./graphics/color": 26,
        "./graphics/dom": 29,
        "./graphics/dom-helper": 27,
        "./graphics/dom-layer": 28,
        "./graphics/drawing": 30,
        "./graphics/gl-textures": 31,
        "./graphics/html": 32,
        "./graphics/image": 33,
        "./graphics/layers": 34,
        "./graphics/particles": 35,
        "./graphics/renderable": 36,
        "./graphics/sprite": 38,
        "./graphics/sprite-animation": 37,
        "./graphics/text": 39,
        "./graphics/viewport": 40,
        "./graphics/webgl": 42,
        "./graphics/webgl-layer": 41,
        "./inputs/device": 43,
        "./inputs/dom-events": 44,
        "./inputs/keyboard": 45,
        "./inputs/lifecycle": 46,
        "./inputs/mouse": 47,
        "./inputs/pointer": 48,
        "./inputs/touch": 49,
        "./inputs/util": 50,
        "./isometric/diamond-iso": 51,
        "./isometric/isometric": 52,
        "./sound/sound": 53
    }],
    ...
    24: [function (require, module, exports) {
        ...
        Crafty._registerLayerTemplate("Canvas", {
            ...
            layerInit: function () {
                ...
                this.__tempSearchRect = {
                    _x: 0,
                    _y: 0,
                    _w: 0,
                    _h: 0
                };
                this.__tempScreenRect = {
                    _x: 0,
                    _y: 0,
                    _w: 0,
                    _h: 0
            ...
            _clean: function () {
                ...
                for (i = 0, l = changed.length; i < l; i++) {
                    ...
                    if (staleKeys === undefined) obj.staleKeys = staleKeys = {
                        x1: 0,
                        y1: 0,
                        x2: 0,
                        y2: 0
        ...
        Crafty.extend({
            ...
            viewport: {
                ...
                init: function (w, h, stage_elem) {
                    ...
                    Crafty.createLayer("DefaultCanvasLayer", "Canvas", {
                        z: 20
                    });
                    Crafty.createLayer("DefaultDOMLayer", "DOM", {
                        z: 30
                    });
                    Crafty.createLayer("DefaultWebGLLayer", "WebGL", {
                        z: 10
                    });
    ...
    48: [function (require, module, exports) {
        ...
        Crafty.extend({
            ...
            findPointerEventTargetByComponent: function (comp, x, y) {
                ...
                var closest = null,
                    current, q, l, i, pos, maxz = -Infinity;
    ...
    55: [function (require, module, exports) {
        ...
        Crafty.extend({
            ...
            raycast: function (origin, direction) {
                ...
                if (sort) results.sort(function (a, b) {
    ...
    57: [function (require, module, exports) {
        ...
        var __motionProp = function (self, prefix, prop, setter) {
            ...
            if (setter) {
                Crafty.defineField(self, publicProp, function () {
        ...
        var __motionVector = function (self, prefix, setter, vector) {
            ...
            if (setter) {
                Crafty.defineField(vector, "x", function () {
                    return self[privateX];
                }, function (v) {
                    self[publicX] = v;
                });
                Crafty.defineField(vector, "y", function () {
